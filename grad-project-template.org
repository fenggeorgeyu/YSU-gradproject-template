...
[2] Fox, J. (2002). _Appendix to An R and S-PLUS Companion to Applied Regression_. http://cran.r-project.org/doc/contrib/Fox-Companion/appendix-bootstrapping.pdf

[3] 

[4] THE FORMAT OF THE REFERENCES MUST BE CONSISTENT. 

[5] 

[6] DO NOT COPY/PASTE REFERENCES FROM THE INTERNET. They will almost
surely be in a different format. Take thirty seconds and translate the
reference into a format consistent with the ones above.
...
Roman). For instance, you should write =summary()= instead of summary().
...
downloaded from:
http://www.cc.ysu.edu/~gjkerns/gradresources.php
#+END_VERSE
